...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_image', type=str, required=True, help='Path to the output image name')
    ...
    if args.video:
        ...
        for i, output_image in enumerate(tqdm(output_images, desc="Saving images")):
            output_image.save(os.path.join(args.output_dir, args.output_image))
